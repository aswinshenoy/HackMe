...
const devices = [
    ...
    },
    {
        ...
        "options": [
            { "id": 1, "label": "Pair it with your phone and keep using it." },
            ...
            { "id": 4, "label": "Turn On all features but not pair it.", correct: true }
        ],
    ...
    },
    {
        ...
        "options": [
            ...
            { "id": 2, "label": "Download and read the attached documents and signup using the link."},
